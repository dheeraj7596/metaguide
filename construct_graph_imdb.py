...
if __name__ == "__main__":
    ...
    sparse.save_npz(data_path + "G_adult.npz", G_adult)
    sparse.save_npz(data_path + "G_actor.npz", G_actor)
    sparse.save_npz(data_path + "G_actress.npz", G_actress)
    sparse.save_npz(data_path + "G_producer.npz", G_producer)
    sparse.save_npz(data_path + "G_writer.npz", G_writer)
    sparse.save_npz(data_path + "G_director.npz", G_director)
    sparse.save_npz(data_path + "G_composer.npz", G_composer)
    sparse.save_npz(data_path + "G_cinematographer.npz", G_cinematographer)
    sparse.save_npz(data_path + "G_editor.npz", G_editor)
    sparse.save_npz(data_path + "G_prod_designer.npz", G_prod_designer)

    sparse.save_npz(data_path + "G_dir_adult.npz", G_dir_adult)
    sparse.save_npz(data_path + "G_dir_actor.npz", G_dir_actor)
    sparse.save_npz(data_path + "G_dir_actress.npz", G_dir_actress)
    sparse.save_npz(data_path + "G_dir_producer.npz", G_dir_producer)
    sparse.save_npz(data_path + "G_dir_writer.npz", G_dir_writer)
    sparse.save_npz(data_path + "G_dir_composer.npz", G_dir_composer)
    sparse.save_npz(data_path + "G_dir_cinematographer.npz", G_dir_cinematographer)
    sparse.save_npz(data_path + "G_dir_editor.npz", G_dir_editor)
    sparse.save_npz(data_path + "G_dir_prod_designer.npz", G_dir_prod_designer)
    sparse.save_npz(data_path + "G_actor_actress.npz", G_actor_actress)

    pickle.dump(fnust_id, open(data_path + "fnust_id.pkl", "wb"))
    pickle.dump(id_fnust, open(data_path + "id_fnust.pkl", "wb"))

    pickle.dump(adult_id, open(data_path + "adult_id.pkl", "wb"))
    pickle.dump(id_adult, open(data_path + "id_adult.pkl", "wb"))

    pickle.dump(actor_id, open(data_path + "actor_id.pkl", "wb"))
    pickle.dump(id_actor, open(data_path + "id_actor.pkl", "wb"))

    pickle.dump(actress_id, open(data_path + "actress_id.pkl", "wb"))
    pickle.dump(id_actress, open(data_path + "id_actress.pkl", "wb"))

    pickle.dump(producer_id, open(data_path + "producer_id.pkl", "wb"))
    pickle.dump(id_producer, open(data_path + "id_producer.pkl", "wb"))

    pickle.dump(writer_id, open(data_path + "writer_id.pkl", "wb"))
    pickle.dump(id_writer, open(data_path + "id_writer.pkl", "wb"))

    pickle.dump(director_id, open(data_path + "director_id.pkl", "wb"))
    pickle.dump(id_director, open(data_path + "id_director.pkl", "wb"))

    pickle.dump(composer_id, open(data_path + "composer_id.pkl", "wb"))
    pickle.dump(id_composer, open(data_path + "id_composer.pkl", "wb"))

    pickle.dump(cinematographer_id, open(data_path + "cinematographer_id.pkl", "wb"))
    pickle.dump(id_cinematographer, open(data_path + "id_cinematographer.pkl", "wb"))

    pickle.dump(editor_id, open(data_path + "editor_id.pkl", "wb"))
    pickle.dump(id_editor, open(data_path + "id_editor.pkl", "wb"))

    pickle.dump(prod_designer_id, open(data_path + "prod_designer_id.pkl", "wb"))
    pickle.dump(id_prod_designer, open(data_path + "id_prod_designer.pkl", "wb"))

    pickle.dump(dir_adult_id, open(data_path + "dir_adult_id.pkl", "wb"))
    pickle.dump(id_dir_adult, open(data_path + "id_dir_adult.pkl", "wb"))

    pickle.dump(dir_actor_id, open(data_path + "dir_actor_id.pkl", "wb"))
    pickle.dump(id_dir_actor, open(data_path + "id_dir_actor.pkl", "wb"))

    pickle.dump(dir_actress_id, open(data_path + "dir_actress_id.pkl", "wb"))
    pickle.dump(id_dir_actress, open(data_path + "id_dir_actress.pkl", "wb"))

    pickle.dump(dir_producer_id, open(data_path + "dir_producer_id.pkl", "wb"))
    pickle.dump(id_dir_producer, open(data_path + "id_dir_producer.pkl", "wb"))

    pickle.dump(dir_writer_id, open(data_path + "dir_writer_id.pkl", "wb"))
    pickle.dump(id_dir_writer, open(data_path + "id_dir_writer.pkl", "wb"))

    pickle.dump(dir_composer_id, open(data_path + "dir_composer_id.pkl", "wb"))
    pickle.dump(id_dir_composer, open(data_path + "id_dir_composer.pkl", "wb"))

    pickle.dump(dir_cinematographer_id, open(data_path + "dir_cinematographer_id.pkl", "wb"))
    pickle.dump(id_dir_cinematographer, open(data_path + "id_dir_cinematographer.pkl", "wb"))

    pickle.dump(dir_editor_id, open(data_path + "dir_editor_id.pkl", "wb"))
    pickle.dump(id_dir_editor, open(data_path + "id_dir_editor.pkl", "wb"))

    pickle.dump(dir_prod_designer_id, open(data_path + "dir_prod_designer_id.pkl", "wb"))
    pickle.dump(id_dir_prod_designer, open(data_path + "id_dir_prod_designer.pkl", "wb"))

    pickle.dump(actor_actress_id, open(data_path + "actor_actress_id.pkl", "wb"))
    pickle.dump(id_actor_actress, open(data_path + "id_actor_actress.pkl", "wb"))
