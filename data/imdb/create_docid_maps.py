...
if __name__ == "__main__":
    ...
    pickle.dump(adult_docid, open(data_path + "adult_docid_map.pkl", "wb"))
    pickle.dump(actor_docid, open(data_path + "actor_docid_map.pkl", "wb"))
    pickle.dump(actress_docid, open(data_path + "actress_docid_map.pkl", "wb"))
    pickle.dump(producer_docid, open(data_path + "producer_docid_map.pkl", "wb"))
    pickle.dump(writer_docid, open(data_path + "writer_docid_map.pkl", "wb"))
    pickle.dump(director_docid, open(data_path + "director_docid_map.pkl", "wb"))
    pickle.dump(composer_docid, open(data_path + "composer_docid_map.pkl", "wb"))
    pickle.dump(cinematographer_docid, open(data_path + "cinematographer_docid_map.pkl", "wb"))
    pickle.dump(editor_docid, open(data_path + "editor_docid_map.pkl", "wb"))
    pickle.dump(prod_designer_docid, open(data_path + "prod_designer_docid_map.pkl", "wb"))
    pickle.dump(dir_adult_docid, open(data_path + "dir_adult_docid_map.pkl", "wb"))
    pickle.dump(dir_actor_docid, open(data_path + "dir_actor_docid_map.pkl", "wb"))
    pickle.dump(dir_actress_docid, open(data_path + "dir_actress_docid_map.pkl", "wb"))
    pickle.dump(dir_producer_docid, open(data_path + "dir_producer_docid_map.pkl", "wb"))
    pickle.dump(dir_writer_docid, open(data_path + "dir_writer_docid_map.pkl", "wb"))
    pickle.dump(dir_composer_docid, open(data_path + "dir_composer_docid_map.pkl", "wb"))
    pickle.dump(dir_cinematographer_docid, open(data_path + "dir_cinematographer_docid_map.pkl", "wb"))
    pickle.dump(dir_editor_docid, open(data_path + "dir_editor_docid_map.pkl", "wb"))
    pickle.dump(dir_prod_designer_docid, open(data_path + "dir_prod_designer_docid_map.pkl", "wb"))
    pickle.dump(actor_actress_docid, open(data_path + "actor_actress_docid_map.pkl", "wb"))
